...
Source4:        zuul-server-safe.service
Source20:       sysconfig
...
install -p -D -m 0644 %{SOURCE4} %{buildroot}%{_unitdir}/zuul-server-safe.service
...
%{_unitdir}/zuul-server-safe.service
...
- Add zuul-server-safe systemd unit
